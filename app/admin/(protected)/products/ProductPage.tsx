...
import { PRODUCT_TYPE_OPTIONS } from "./constant/admin-product.constant";
...
const ProductFormPage = ({ editProduct = null }: ProductFormPageProps) => {
  ...
  const [modifierGroupsState, setModifierGroupsState] = useState<ModifierGroupUI[]>([]);
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (categorySelection.showCustomCategory && categorySelection.customCategory) {
      ...
      if (categorySelection.showCustomSubcategory && categorySelection.customSubcategory && categoryId) {
